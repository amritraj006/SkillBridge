...
const testimonials = [
  {
    ...
    message: "This platform completely transformed my career. The AI-powered roadmaps guided me from beginner to landing my dream job at a top tech company.",
  ...
  },
  {
    name: "Mark Wilson",
    role: "Data Analyst",
    message: "The practical projects and expert mentorship made all the difference. I switched careers in just 6 months and doubled my salary.",
  ...
  },
  {
    name: "Sara Lee",
    role: "UI/UX Designer",
    message: "The flexibility to learn at my own pace while working full-time was crucial. The certification helped me win multiple freelance clients.",
    avatar: "https://i.pravatar.cc/100?img=3",
    rating: 5,
    achievement: "Top 1% Designer",
...
const Testimonials = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white via-blue-50/30 to-indigo-50/30 py-20 lg:py-28">
      ...
      <div className="absolute top-20 right-1/4 text-blue-200/20 rotate-12 hidden lg:block">
        <Quote size={120} strokeWidth={1} />
      </div>
      <div className="absolute bottom-20 left-1/4 text-indigo-200/20 -rotate-12 hidden lg:block">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              {/* Gradient overlay */}
              <div className={`absolute inset-0 bg-gradient-to-br ${testimonial.gradient} opacity-0 group-hover:opacity-[0.02] rounded-2xl transition-opacity duration-500`} />
              ...
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className={`absolute inset-0 bg-gradient-to-r ${testimonial.gradient} rounded-full blur-md opacity-0 group-hover:opacity-50 transition-opacity duration-500`} />
                  <img
