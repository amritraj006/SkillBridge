...
// 2️⃣ Sample courses with working images from Unsplash
const sampleCourses = [
...
const insertSampleCourses = async () => {
  try {
    ...
    console.log(`✅ ${createdCourses.length} sample courses inserted successfully:`);
    ...
    createdCourses.slice(0, 10).forEach((course) => console.log(`   • ${course.title}`));
